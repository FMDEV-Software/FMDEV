...
class TrainModel extends Component {
  ...
  if(value==='1'){
  	...
  	header.textContent = 'Acurácia de teste';
  
  	const header2 = document.getElementById('header2');
  	header2.textContent = 'Última predição em';
  
  	const header3 = document.getElementById('header3');
  	header3.textContent = 'Predições realizadas';
  }
  
  if(value==='2'){
  	const header = document.getElementById('header1');
  	header.textContent = 'Quantidade de Grupos';
  
  	const header2 = document.getElementById('header2');
  	header2.textContent = 'Ultimo agrupamento em';
  
  	const header3 = document.getElementById('header3');
  	header3.textContent = 'Agrupamentos realizados';
  }
	...
	<div className="header">
		<div className="titulo-inicial">
          	...
          	<div className="select">
          		<select onChange={this.onChange} id="Selection">
          			<option value="1">Classificação</option>
    				<option value="2">Agrupamento</option>
    	   		</select>
    	   	</div>
    	</div>   	
            ...
            <Table className="resultado">
              <thead>
                <tr>
                  ...
                  <HeaderColumn id="header1">Acurácia de teste</HeaderColumn>
                  <HeaderColumn id="header2">Última predição em</HeaderColumn>
                  <HeaderColumn id="header3">Predições realizadas</HeaderColumn>
