...
class TrainModelAgrupamento extends Component {
    ...
    return (
      <PerfectScrollbar style={{ width: '100%', overflowX: 'auto' }}>
        <ConfigContainer size='big' style={{ color: '#000' }}>
          ...
          <select onChange="onChange(this)"id="framework">
            ...
            <Table>
              <thead>
                <tr>
                  ...
                  <HeaderColumn>Quantidade de Grupos</HeaderColumn>
                  <HeaderColumn>Ultimo Agrupamento</HeaderColumn>
                  <HeaderColumn>Agrupamentos realizados</HeaderColumn>
